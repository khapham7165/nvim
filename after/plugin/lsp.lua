...
local function on_attach(client, bufnr)
  ...
  vim.keymap.set('n', 'gd', GoToDefinitionInFloat, vim.tbl_extend('force', opts, {
    desc = "Go to definition"
  }))

  vim.keymap.set('n', 'gld', '<C-w>v<C-]>', vim.tbl_extend('force', opts, {
  ...
  vim.keymap.set('n', '<space>D', vim.lsp.buf.type_definition, vim.tbl_extend('force', opts, {
    desc = "Go to type definition"
  }))
  vim.keymap.set('n', '<space>rn', vim.lsp.buf.rename, vim.tbl_extend('force', opts, {
    desc = "Rename symbol"
  }))
  vim.keymap.set('n', 'gr', vim.lsp.buf.references, vim.tbl_extend('force', opts, {
    desc = "Show references"
  }))
  vim.keymap.set('n', '<leader>.', vim.lsp.buf.code_action, vim.tbl_extend('force', opts, {
    desc = "Code actions"
  }))
  ...
  ["tailwindcss"] = function()
    ...
    lspconfig.tailwindcss.setup({
      ...
      root_dir = function(fname)
        ...
        local root = lspconfig.util.root_pattern('tailwind.config.js', 'tailwind.config.cjs', 'tailwind.config.mjs',
            'tailwind.config.ts', 'package.json')(fname)
